...
import KbdSlotExample from '../../components/examples/kbd/KbdSlotExample.vue'
...
const kbdConfig: ComponentDocConfig = {
  ...
  usage: [
    {
      title: 'Uso básico',
      description: 'Proporciona un label para mostrar una tecla de teclado.',
  ...
  examples: [
    ...
    {
      title: 'Variant',
      description: 'Elige el tratamiento visual de la tecla.',
      component: KbdVariantExample,
    },
    {
      title: 'Severity',
      description: 'Aplica una severidad semántica al tratamiento visual.',
      component: KbdSeverityExample,
    },
    {
      title: 'Color',
      description: 'Aplica un color CSS personalizado a la tecla.',
      component: KbdColorExample,
    },
    {
      title: 'Slot',
      description: 'Sustituye el label por contenido personalizado mediante el slot default.',
      component: KbdSlotExample,
    },
  ],
  accessibility: [
    {
